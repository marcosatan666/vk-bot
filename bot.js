...
bot.command("Примеры работ", ctx => {
    ctx.reply("Я Соня и с детства увлекаюсь рисованием. С приобретением графического планшета, я наконуц-то могу воплотить свои идеи не только на бумаге, но и в диджитале. Круто, да? А, точно, примеры работ...Пока что их не так уж и много, но я хочу делать свое портофолио ярким и насыщенным, а для этого нужно время. Поэтому, мой дружок-пирожок, потерпи месяцок.", "photo349515008_457264640", Markup.keyboard([
